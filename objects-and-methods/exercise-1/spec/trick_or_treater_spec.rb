...
RSpec.describe TrickOrTreater do
  it 'wears a costume' do
    ...
    trick_or_treater1 = TrickOrTreater.new(costume1)
    expect(trick_or_treater1.dressed_up_as).to eq('Cowboy')
  end

  it 'can have a different costume' do
    trick_or_treater1 = TrickOrTreater.new(Costume.new('Alien'))

    expect(trick_or_treater1.dressed_up_as).to eq('Alien')
  end

  it 'has an empty bag by default' do
    trick_or_treater1 = TrickOrTreater.new(Costume.new("Alien"))

    expect(trick_or_treater1.bag.empty?).to be true
  end
  ...
  it 'can get candies' do
    ...
    trick_or_treater.bag.place_candy(Candy.new('Gummy bears'))
  ...
  it 'can eat candies' do
    ...
    trick_or_treater.bag.place_candy(Candy.new("Gummy worms"))
    trick_or_treater.bag.place_candy(Candy.new("Liquorice"))
    trick_or_treater.bag.place_candy(Candy.new("Salty Serpents"))
